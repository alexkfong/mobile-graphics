...
function App() {
  ...
  const qr = `${base}assets/adobe-express-qr-code.png`;
    ...
    <>
      ...
      <article>
        ...
        <section id='basic' className='mb-xl'>
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                <li>
                  <b>Mac:</b> Cmd + Option + I
                </li>
                <li>
                  <b>Windows/Linux:</b> Ctrl + Shift + I
                </li>
              </ul>
            </li>
            <li>
              Click the <b>Accessibility</b> tab in DevTools. If prompted, click{' '}
              <b>Enable accessibility</b> features.
            </li>
            <li>
              Right-click shortcut: Right-click an element on the page. Click
        ...
        <section id='anatomy' className='mb-xl'>
          ...
          <Ai2html base={base} graphic={'anatomy'} />
          <ul>
            <li>
        ...
        <section id='complex' className='mb-xl'>
          ...
          <p>
            To make this chart, Andrew put the data into{' '}
            <a
            ...
            and used the steamgraph visualization option. We ended up splitting
            the average and 2023 data and putting them in separately to generate
